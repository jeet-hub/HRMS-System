        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Eployees</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('Staff/insert');?>
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Company Accets</label>
                    <input type="text" name="txtcity" class="form-control" placeholder="laptop,Pc,mic,Headphone">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="password" name="txtstate" class="form-control" placeholder="****">
                  </div>
                </div>
