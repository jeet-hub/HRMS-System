          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                   <!-- <strong><?php echo $cnt['staff_name']; ?></strong> -->
                  <small><small>#00<?php echo rand(1000,100)?></small></small>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>view-staff"><i class="fa fa-dashboard"></i> <span>Staff</span></a></li>
